...
.setColor("RANDOM")
.setDescription(`Kullanıcının ismi \`${ayarlar.tag} ${isim} ${ayarlar.sembol} ${yaş}\` olarak değiştirildi ve <@&${ayarlar.erkekRol1}>, <@&${ayarlar.erkekRol2}> <@&${ayarlar.erkekRol}> <@&${ayarlar.vipRol}> rolleri verildi!`)
...
exports.config = {
    name: "viperkek",
    guildOnly: true,
    aliases: ["ve","viperkek","vipe","verkek"]
}